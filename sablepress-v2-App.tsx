...
export default function App() {
  ...
  function buildSablesound(cues = [0.2]) {
    ...
    const boom = (atSec) => {
      ...
      g.gain.exponentialRampToValueAtTime(0.85, at + 0.025);
      ...
      sg.gain.exponentialRampToValueAtTime(0.5, at + 0.015);
  ...
  return (
    <div style={S.app}>
      ...
      <header style={S.header}>
        ...
        <span style={S.sub}>2D generator · cards · backdrops · video · motion · sound · v10</span>
      </header>
