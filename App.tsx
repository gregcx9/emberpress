...
- Begin EVERY reply with the line "${(attribution.split(",")[0] || "Set").trim().charAt(0) + (attribution.split(",")[0] || "Set").trim().slice(1).toLowerCase()} set ${campaignNo} — image X of 4" (X = the image you are generating) so I can track which set and image this is.
