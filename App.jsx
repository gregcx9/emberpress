...
// Rotation index persists in localStorage — every tap serves the next unused line.
const COMMENT_BANK = [
  { cat: "Villain / morally-grey", emoji: "🖤", searches: ["morally grey men", "dark romance villain", "book boyfriend dark", "villain edit books"], lines: [
    ...
    "He didn't fall for her. He descended. On purpose.",
    "Every villain is just a man who stopped apologizing.",
    "She wanted safe. He offered kept. There's a difference, and it has teeth.",
    "The morally grey ones don't lie. They just tell the truth too late.",
    "A good man loves you. A ruined one memorizes you.",
    "Heroes save the world. Villains save one person and let the world file a complaint.",
    "The red flag was a banner. She enlisted.",
    "Soft hands write poems. Scarred ones keep promises.",
    "He never said he was good. He said he was hers. Only one of those was load-bearing.",
    "The devil doesn't tempt. He waits. Patience is the scariest love language.",
    "Gentlemen open doors. He removes them.",
    "She's not afraid of him. She's afraid of how unafraid she is.",
    "His love isn't a cage. It's a keep. Look up the difference.",
    "The villain always recognizes her first. That's the whole tragedy.",
    "Good men grieve what they lose. He simply doesn't allow the category.",
    "He counts her breaths like debts. And he always collects.",
    "The warning label was the love letter.",
    "Kind is a mood. Devoted is a diagnosis.",
    "He keeps his word the way winter keeps the cold.",
    "Every soft word he says costs him something. That's why she believes them.",
    "He doesn't want her heart. He wants the ledger it's written in.",
    "A hero would ask what she wants. He took notes years ago.",
    "The best villains love like it's the last legal thing they do.",
    "He's the kind of wrong that makes right look lazy.",
    "Some men bring flowers. He brings the whole garden, roots and all.",
    "The scariest thing he ever said was 'take your time.' He meant forever.",
    "A villain's promise outlasts a hero's vow. Ask any widow in the genre.",
  ] },
  { cat: "Heartbreak / angst", emoji: "🥀", searches: ["book angst", "books that broke me", "sad book quotes", "romantasy angst"], lines: [
    ...
    "Some chapters you read. Some chapters read you.",
    "The saddest line in any book is the one you already lived.",
    "He loved her in the past tense while standing right in front of her.",
    "Angst is just hope with a bruise.",
    "The book didn't break my heart. It found the crack that was already there.",
    "Grief doesn't end the love story. It just takes over the narration.",
    "She kept the letter. Not to reread it. To prove it existed.",
    "Almost is the heaviest word in the language.",
    "Nobody warns you the last time feels like every other time.",
    "He said her name like an apology. She heard it like a verdict.",
    "Some goodbyes are said with the door still open. Those are the worst ones.",
    "You don't reread the sad ones to feel sad. You reread them to feel understood.",
    "The quiet after the fight is louder than the fight.",
    "Love doesn't always leave. Sometimes it just stops answering.",
    "The epilogue I needed was one more ordinary morning.",
    "She didn't cry at the ending. She cried at the dedication.",
    "Missing someone is just memory with a pulse.",
    "The tragedy isn't that it ended. It's that it almost didn't.",
    "Books like this don't hurt you. They hold the hurt up to the light.",
    "He never lied to her. He just told the truth in a way that arrived too late.",
    "Some love stories are just grief with a head start.",
    "The bravest sentence in the book: she stayed anyway. The saddest: so did he.",
    "You know it's good angst when you check the page count like a prognosis.",
    "Every unsent letter is a finished book.",
    "The ones we don't get over, we get built around.",
    "The right person at the wrong time is still the wrong chapter.",
  ] },
  { cat: "Genre defense", emoji: "🔥", searches: ["why I read dark romance", "dark romance explained", "dark romance community"], lines: [
    ...
    "Dark romance isn't wanting danger. It's wanting to be chosen by something that could have chosen anything.",
    "We read villains because the world already taught us the monsters. The books just give them better dialogue.",
    "It's fiction. That's the point. The one place the fire is behind glass.",
    "Nobody asks horror readers if they're okay. Interesting.",
    "The genre isn't dark. It's honest with the lights off.",
    "We don't romanticize pain. We annotate it.",
    "The happy ending hits harder when the road there had teeth.",
    "It's not a red flag collection. It's a field guide.",
    "Women read dark romance for the same reason people watch storms from the porch.",
    "Judging the reader by the book is like judging the surgeon by the blood.",
    "The genre asks one question over and over: what would you forgive?",
    "Every 'why do you read that' has the same answer: because it ends.",
    "Dark romance: where the danger is fictional and the catharsis is not.",
    "We like our monsters literate.",
    "The spice isn't the point. The reckoning is.",
    "People fear the books that name things. Readers underline them.",
    "Escapism is a beach read. This is a locksmith.",
    "The genre's secret: the villain is never the scariest thing in the book. The hope is.",
    "We're not confused about real life. That's exactly why the shelf looks like this.",
    "Nobody writes a yes more carefully than the genre you think ignores it.",
    "Dark romance readers have the best boundaries. We've read every way they break.",
    "It's cheaper than therapy and the villain validates faster.",
    "The question isn't why women read it. It's why the question only comes up for women.",
    "Fiction is a flight simulator for feelings. This one files a more interesting flight plan.",
    "Reading dark romance is a trust exercise with an author instead of a person. Better odds.",
    "The lights-off genres tell the lights-on truths.",
  ] },
  { cat: "Hauls / TBR", emoji: "📚", searches: ["book haul", "tbr pile", "dark romance haul", "bookshelf tour"], lines: [
    ...
    "A bookshelf is autobiography in spines.",
    "The TBR isn't a list. It's a promise ledger.",
    "Buying a book is voting for the person you plan to become.",
    "My TBR has a TBR.",
    "Shelf space is a myth invented by people who don't understand hoards.",
    "Every haul is just future-you receiving a care package.",
    "The unread books aren't guilt. They're options.",
    "A dragon doesn't apologize for the hoard. Neither do we.",
    "The stack isn't out of control. It's ambition in hardback.",
    "New book smell is just possibility off-gassing.",
    "You can tell a reader's whole year by which shelf got heavier.",
    "Book buying bans last exactly one cover reveal.",
    "The haul isn't impulsive. It was preordained. By the preorder.",
    "Some people collect stamps. We collect futures.",
    "The TBR pile is a skyline now. Zoning laws do not apply.",
    "Rearranging the shelves absolutely counts as reading.",
    "One more book won't hurt, said everyone correctly.",
    "Your TBR isn't behind. The calendar is.",
    "We don't have too many books. We have too few walls.",
    "Unhauling is just making room for the sequel's sequel.",
    "Buying the special edition of a book you own is called devotion, look it up.",
    "The TBR knows what it's doing. Trust the hoard.",
    "Every spine on that shelf is a door you get to keep.",
    "Add to cart is a love language.",
    "The library card is the only card that never declines your dreams.",
    "A stack by the bed is a nightlight for the soul.",
    "The haul video is just show and tell for adults who turned out great.",
  ] },
  { cat: "Reaction / destroyed me", emoji: "😭", searches: ["book hangover", "this book destroyed me", "finished this book crying"], lines: [
    ...
    "A five-star read doesn't end. It relocates into your chest.",
    "The hangover is the book refusing to check out.",
    "You know it destroyed you when you thank it.",
    "Finished at 3am. Stared at the ceiling. The ceiling understood.",
    "Some endings you close gently, like you don't want to wake them.",
    "The best books leave fingerprints on everything you read after.",
    "Rating it five stars felt like signing a confession.",
    "It's been three days and I'm still living in that epilogue.",
    "You grieve characters who never existed harder than plans that did. That's craft.",
    "I didn't read the last chapter. I braced for it.",
    "Book hangover cure: there isn't one. Hydrate and reread.",
    "You don't finish books like this. You survive them.",
    "The audacity of an author to write that and just go make tea.",
    "Closed the book. Opened it again to check it really did that. It did.",
    "Some books end and you immediately need to tell a stranger.",
    "The reread hits different when you know what page 300 is planning.",
    "It destroyed me on page one and I said thank you.",
    "My search history is just the character's name plus 'deserved better'.",
    "That ending rearranged my furniture.",
    "A book hasn't hurt me like this since the last one I said that about.",
    "Five stars, one apology owed to my sleep schedule.",
    "The quiet after the last page is a room the author built on purpose.",
    "I need a sequel, a prequel, and a formal explanation.",
    "Books like this should come with aftercare.",
    "Not me holding a funeral for a fictional man on my lunch break.",
    "The ending was a trapdoor and I'm still falling.",
    "Read it in one sitting. The sitting lasted nine hours.",
  ] },
  { cat: "Spice discourse", emoji: "🌶", searches: ["spicy booktok", "slow burn romance", "spice tolerance books"], lines: [
    "The tension is the spice. The rest is just paperwork.",
    "A slow burn is just spice with a savings account.",
    "The almost-touch outranks the touch. This is settled law.",
    "Spice tolerance is built, like calluses. From volume one.",
    "The hottest line in the book had zero anatomy in it.",
    "Fade to black is fine. Fade to feelings is fatal.",
    "One bed. That's it. That's the comment.",
    "The glove removal scene did more than most trilogies.",
    "Spice without tension is cardio.",
    "'Say it again' is spicier than anything in chapter 30.",
    "The burn isn't slow. It's thorough.",
    "Hand on the small of the back: literary weapon of mass destruction.",
    "We measure spice in chili peppers because thermometers gave up.",
    "The scene everyone screenshots is never the spicy one. It's the one before it.",
    "Tension is a promise. Spice is the receipt.",
    "A well-written 'don't' is hotter than a badly written everything.",
    "The knuckle kiss is doing unpaid overtime in this genre.",
    "Spice level: he said her full name. Slowly.",
    "Proximity is a genre. One bed is its capital.",
    "The pause before the kiss is the whole economy.",
    "Slow burn readers don't skim. We invest.",
    "It's not about the spice level. It's about the emotional interest rate.",
    "'Who did this to you' — four words, one shared pulse.",
    "The spiciest thing a man can do in a book is listen. Twice.",
    "Chapter counts are just foreplay math.",
    "Touch her and the plot ends. Touch her hand and the plot begins.",
    "We don't skip to the scene. The scene is chapters 1 through 29.",
    "Forehead touch in chapter 27 > entire other books.",
    "Some like it fade-to-black. Some like it floodlit. The genre caters.",
    "The spice debate has two sides and one shared bookmark.",
  ] },
];
...
export default function App() {
  ...
  const [vidPrevErr, setVidPrevErr] = useState(null); // url of a blob the inline player refused
  ...
  function buildCampaign() {
    ...
    const setName = (attribution.split(",")[0] || "Set").trim();
    const setLabel = setName.charAt(0) + setName.slice(1).toLowerCase();
    const prompts = `${setLabel} set ${campaignNo}
...
- Begin EVERY reply with the line "${setLabel} set ${campaignNo} — image X of 4" (X = the image you are generating) so I can track which set and image this is.
...
${KIT_TAGS[platform](seriesTag)} #slowburn #newbooks`);
  ...
  // ---- book links: permanently stored in localStorage, dropdown + copy ----
  const [bookLinks, setBookLinks] = useState(() => {
    try { return JSON.parse(localStorage.getItem("sable_book_links") || "[]"); } catch (e) { return []; }
  });
  const [linkSel, setLinkSel] = useState(0);
  const [newLinkTitle, setNewLinkTitle] = useState("");
  const [newLinkUrl, setNewLinkUrl] = useState("");

  function saveBookLinks(arr) {
    setBookLinks(arr);
    try { localStorage.setItem("sable_book_links", JSON.stringify(arr)); } catch (e) {}
  }
  function addBookLink() {
    if (!newLinkTitle.trim() || !newLinkUrl.trim()) { alert("Enter a book title and its Amazon link."); return; }
    const arr = [...bookLinks, { title: newLinkTitle.trim(), url: newLinkUrl.trim() }];
    saveBookLinks(arr);
    setLinkSel(arr.length - 1);
    setNewLinkTitle(""); setNewLinkUrl("");
  }
  function deleteBookLink() {
    if (!bookLinks[linkSel]) return;
    if (!confirm(`Delete "${bookLinks[linkSel].title}"?`)) return;
    const arr = bookLinks.filter((_, i) => i !== linkSel);
    saveBookLinks(arr);
    setLinkSel(0);
  }

  const GIFTHELD_CTA = "Comment GIFTHELD and I'll send you the link the second it goes free 👇";
...
${ctaSub} — ${series}. Link in bio.`);
  ...
  // ---- daily comment rounds: rotation index persists in localStorage, never repeats until the bank is exhausted ----
  const [cmtLast, setCmtLast] = useState("");

  function tapComment(ci) {
    const bank = COMMENT_BANK[ci];
    let idxMap = {};
    try { idxMap = JSON.parse(localStorage.getItem("sable_cmt_idx") || "{}"); } catch (e) {}
    const idx = (idxMap[ci] || 0) % bank.lines.length;
    const line = bank.lines[idx];
    idxMap[ci] = (idx + 1) % bank.lines.length;
    try { localStorage.setItem("sable_cmt_idx", JSON.stringify(idxMap)); } catch (e) {}
    setCmtLast(`${bank.emoji} ${bank.cat} — comment #${idx + 1} of ${bank.lines.length}:\n${line}`);
    robustCopy(line, `Comment #${idx + 1}/${bank.lines.length} copied — paste on a fresh (<6h) video from a bigger account. Never a link.`);
  }

  function copySearch(term) {
    robustCopy(term, "Search term copied — paste into TikTok search, then Filters → most recent.");
  }
  ...
  return (
    <div style={S.app}>
      ...
      <header style={S.header}>
        <span style={S.brand}>SABLEPRESS</span><span style={{ fontSize: 10, opacity: 0.5, marginLeft: 6, letterSpacing: 1 }}>v16</span>
      ...
      <main style={S.main}>
          ...
          <div style={{ flex: 1, minWidth: 280 }}>
            ...
            <div style={S.panel}>
              ...
              <div style={{ borderTop: "1px solid #2A2622", marginTop: 16, paddingTop: 12 }}>
                ...
                <button style={{ ...S.primaryBtn, width: "100%", marginTop: 12, padding: "16px 12px", fontSize: 14, background: "#7A4A3A", color: "#EDE7DE" }}
                  onClick={() => robustCopy(GIFTHELD_CTA, "CTA copied — pin it, then reply to every GIFTHELD comment with the link when it goes free.")}>
                  📣 Copy "Comment GIFTHELD" CTA
                </button>

                <div style={{ marginTop: 14 }}>
                  <div style={S.panelTitle}>📚 BOOK LINKS — stored on this device</div>
                  {bookLinks.length > 0 ? (
                    <>
                      <select value={linkSel} onChange={(e) => setLinkSel(Number(e.target.value))} style={{ ...S.input, marginTop: 8 }}>
                        {bookLinks.map((b, i) => <option key={i} value={i}>{b.title}</option>)}
                      </select>
                      <div style={{ display: "flex", gap: 8, marginTop: 8 }}>
                        <button style={{ ...S.primaryBtn, flex: 1 }} onClick={() => bookLinks[linkSel] && robustCopy(bookLinks[linkSel].url, `${bookLinks[linkSel].title} link copied.`)}>📋 Copy link</button>
                        <button style={{ ...S.ghostBtn, padding: "10px 14px" }} onClick={deleteBookLink}>✕</button>
                      </div>
                    </>
                  ) : (
                    <p style={S.small}>No links saved yet — add each book's Amazon link once below.</p>
                  )}
                  <input placeholder="Book title (e.g. The Gift Held)" value={newLinkTitle} onChange={(e) => setNewLinkTitle(e.target.value)} style={{ ...S.input, marginTop: 8 }} />
                  <input placeholder="Amazon link (https://…)" value={newLinkUrl} onChange={(e) => setNewLinkUrl(e.target.value)} style={{ ...S.input, marginTop: 8 }} />
                  <button style={{ ...S.ghostBtn, width: "100%", marginTop: 8 }} onClick={addBookLink}>＋ Save book link</button>
                </div>
              </div>
              ...
              <div style={{ borderTop: "1px solid #2A2622", marginTop: 16, paddingTop: 12 }}>
                ...
                {COMMENT_BANK.map((b, ci) => (
                  <div key={b.cat} style={{ marginTop: 10 }}>
                    ...
                    <div style={{ display: "flex", gap: 6, marginTop: 6, flexWrap: "wrap" }}>
                      {b.searches.map((t) => (
                        <button key={t} style={{ ...S.ghostBtn, padding: "6px 10px", fontSize: 11.5 }} onClick={() => copySearch(t)}>📋 {t}</button>
                      ))}
                    </div>
                  </div>
                ))}
        ...
        {(gallery.length > 0 || videoOut) && (
          <section style={{ marginTop: 26 }}>
            ...
            {videoOut && (
              <div style={{ marginTop: 12 }}>
                {vidPrevErr === videoOut.url ? (
                  <div style={{ width: "100%", maxWidth: 480, borderRadius: 12, border: "1px solid #2A2622", background: "#161310", padding: "22px 16px", textAlign: "center" }}>
                    <div style={{ fontSize: 28 }}>🎞</div>
                    <p style={{ ...S.small, marginTop: 6 }}>Video is ready — this browser just can't preview it in-page.<br /><strong style={{ color: "#EDE7DE" }}>Tap Save below, then play it in Photos.</strong></p>
                  </div>
                ) : (
                  <video controls playsInline muted preload="metadata" src={videoOut.url}
                    onError={() => setVidPrevErr(videoOut.url)}
                    style={{ width: "100%", maxWidth: 480, borderRadius: 12, border: "1px solid #2A2622", display: "block" }} />
                )}
